...
class HighlighterTestCase(unittest.TestCase):
    def test_highlight_words_in_text(self):
        ...
        result = highlight_words_in_text(text, words)
        self.assertEqual(result, expected_output)

    def test_highlight_words_in_text_case_insensitive(self):
        text = "This is a case-insensitive Test."
        words = ["TEST"]
        expected_output = "This is a case-insensitive <span>Test</span>."
        result = highlight_words_in_text(text, words, case_insensitive=True)
        self.assertEqual(result, expected_output)

    def test_highlight_words_in_text_with_substring_overlapping(self):
    ...
    def test_highlight_words_in_text_with_overlapping(self):
    ...
    def test_highlight_words_in_text_with_multiple_overlapping(self):
        text = "This is a test with overlapping words."
    ...
    def test_highlight_words_in_text_no_words_to_highlight(self):
    ...
    def test_highlight_words_in_text_empty_text(self):
        text = ""
    ...
    def test_highlight_words_in_text_multiple_occurrences(self):
